...
This project will explore the potential differences in morphology in two colour morphs of the rock crab *Leptograpsus variegatus* using data collected by Campbell and Mahon (1974).
...
In accessing the data, I have only completed simple visualizations of data distributions (histograms). I have only read through the introduction and data collection procedures of Campbell and Mahon (1974).
...
Campbell and Mahon (1974) do not provide a reasoning for sample size selected. Additional data for these populations from other data sources was not found due to time constraints and lack of open availability.
